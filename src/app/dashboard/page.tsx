...
export default async function DashboardPage() {
  ...
  return (
    <div>
      ...
      <p className="mt-2 text-gray-600">Your secure CMS foundation with Neon Auth is ready.</p>
      ...
      <div className="mt-8 grid grid-cols-1 gap-4 sm:grid-cols-3">
        ...
        <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
          ...
          <p className="mt-2 text-lg font-semibold text-green-600">Secured via Neon</p>
        </div>
      </div>
    </div>
  );
