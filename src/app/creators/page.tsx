  ...
  return (
    <div>
      ...
      <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200 mb-8">
        ...
        <form action={addCreator} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          ...
          <input name="contactEmail" type="email" placeholder="Contact Email" className="rounded-md border border-gray-300 px-3 py-2 focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 outline-none" />
          <input name="phone" type="text" placeholder="Phone Number" className="rounded-md border border-gray-300 px-3 py-2 focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 outline-none" />
          ...
          <input name="notes" type="text" placeholder="Notes" className="rounded-md border border-gray-300 px-3 py-2 focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 outline-none md:col-span-2" />
          <button type="submit" className="bg-indigo-600 text-white font-semibold rounded-md hover:bg-indigo-500 transition-colors py-2 md:col-span-3 lg:col-span-1">
            Add Creator
          </button>
        </form>
      </div>
              ...
              {allCreators.length === 0 ? (
                ...
                allCreators.map((creator) => (
                  <tr key={creator.id} className="hover:bg-gray-50 transition-colors">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{creator.email || creator.contactEmail || '-'}</td>
